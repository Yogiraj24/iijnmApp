	...
	<table cellpadding="3" cellspacing="0" border="1" class="formContainer">
		<tbody>
			...
			<tr>
				...
				Locations</label></td>
				<td width="588"><html:select property="england" multiple="2" size="10">
			...
			<tr>
				<td width="211" align="center"><label>Please select values if you supply into these
				Markets</label></td>
				<td width="588"><html:select property="scotland" multiple="2" size="10">
			...
			<tr>
			<td>Others</td>
			<td><html:text property="others"></html:text></td>
			</tr>
			<tr>
