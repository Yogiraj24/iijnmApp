...
/** 
 * This class represents the primary key of the markets table.
 */
public class MarketsPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof MarketsPk)) {
			return false;
		}
		
		final MarketsPk _cast = (MarketsPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.hp.supplier.dto.MarketsPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
