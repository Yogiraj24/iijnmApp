...
/** 
 * This class represents the primary key of the work_experience table.
 */
public class WorkExperiencePk implements Serializable
{
	 ...
	 * @param id
	 */
	public WorkExperiencePk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof WorkExperiencePk)) {
			return false;
		}
		
		final WorkExperiencePk _cast = (WorkExperiencePk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.edu.iijnm.dto.WorkExperiencePk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
